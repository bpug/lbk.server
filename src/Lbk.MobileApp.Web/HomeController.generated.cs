...
namespace Lbk.MobileApp.Web.Controllers
{
    public partial class HomeController
    {
        ...
        public class ActionParamsClass_SetCulture
        {
            ...
            public readonly string currentAction = "currentAction";
            public readonly string currentController = "currentController";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Lbk.MobileApp.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void SetCultureOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string culture, string currentAction, string currentController, string currentId);

        [NonAction]
        public override System.Web.Mvc.ActionResult SetCulture(string culture, string currentAction, string currentController, string currentId)
        {
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "currentAction", currentAction);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "currentController", currentController);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "currentId", currentId);
            SetCultureOverride(callInfo, culture, currentAction, currentController, currentId);
            return callInfo;
        }
