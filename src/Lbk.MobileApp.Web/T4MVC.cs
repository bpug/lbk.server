...
{
    public static Lbk.MobileApp.Web.Controllers.AccountController Account = new Lbk.MobileApp.Web.Controllers.T4MVC_AccountController();
    public static Lbk.MobileApp.Web.Controllers.AnswerController Answer = new Lbk.MobileApp.Web.Controllers.T4MVC_AnswerController();
    public static Lbk.MobileApp.Web.Controllers.BaseController Base = new Lbk.MobileApp.Web.Controllers.T4MVC_BaseController();
    public static Lbk.MobileApp.Web.Controllers.CategoryController Category = new Lbk.MobileApp.Web.Controllers.T4MVC_CategoryController();
    public static Lbk.MobileApp.Web.Controllers.EventController Event = new Lbk.MobileApp.Web.Controllers.T4MVC_EventController();
    public static Lbk.MobileApp.Web.Controllers.FoodController Food = new Lbk.MobileApp.Web.Controllers.T4MVC_FoodController();
    public static Lbk.MobileApp.Web.Controllers.HomeController Home = new Lbk.MobileApp.Web.Controllers.T4MVC_HomeController();
    public static Lbk.MobileApp.Web.Controllers.LocaleController Locale = new Lbk.MobileApp.Web.Controllers.T4MVC_LocaleController();
    public static Lbk.MobileApp.Web.Controllers.MenuController Menu = new Lbk.MobileApp.Web.Controllers.T4MVC_MenuController();
    public static Lbk.MobileApp.Web.Controllers.PictureController Picture = new Lbk.MobileApp.Web.Controllers.T4MVC_PictureController();
    public static Lbk.MobileApp.Web.Controllers.QuestionController Question = new Lbk.MobileApp.Web.Controllers.T4MVC_QuestionController();
    public static Lbk.MobileApp.Web.Controllers.SerieController Serie = new Lbk.MobileApp.Web.Controllers.T4MVC_SerieController();
    public static Lbk.MobileApp.Web.Controllers.SpeisekarteController Speisekarte = new Lbk.MobileApp.Web.Controllers.T4MVC_SpeisekarteController();
    public static Lbk.MobileApp.Web.Controllers.StatisticsController Statistics = new Lbk.MobileApp.Web.Controllers.T4MVC_StatisticsController();
    public static Lbk.MobileApp.Web.Controllers.VideoController Video = new Lbk.MobileApp.Web.Controllers.T4MVC_VideoController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class globalization {
            ...
            public static class cultures {
                private const string URLPATH = "~/Scripts/globalization/cultures";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class globdatepicker {
            private const string URLPATH = "~/Scripts/globdatepicker";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string jquery_ui_datepicker_de_DE_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.ui.datepicker.de-DE.min.js") ? Url("jquery.ui.datepicker.de-DE.min.js") : Url("jquery.ui.datepicker.de-DE.js");
        }
        ...
        public static readonly string methods_de_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/methods_de.min.js") ? Url("methods_de.min.js") : Url("methods_de.js");
        ...
        public static class statistics {
            private const string URLPATH = "~/Scripts/statistics";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static readonly string copy_jpg = Url("copy.jpg");
