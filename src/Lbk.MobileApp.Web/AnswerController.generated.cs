...
namespace Lbk.MobileApp.Web.Controllers
{
    public partial class AnswerController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _grid = "~/Views/Answer/_grid.cshtml";
            public readonly string _search = "~/Views/Answer/_search.cshtml";
            public readonly string Create = "~/Views/Answer/Create.cshtml";
            public readonly string Delete = "~/Views/Answer/Delete.cshtml";
            public readonly string Detail = "~/Views/Answer/Detail.cshtml";
            public readonly string Edit = "~/Views/Answer/Edit.cshtml";
            public readonly string List = "~/Views/Answer/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AnswerController : Lbk.MobileApp.Web.Controllers.AnswerController
    {
        public T4MVC_AnswerController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long questionId, Lbk.MobileApp.Web.Models.AnswerFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(long questionId, Lbk.MobileApp.Web.Models.AnswerFormModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "questionId", questionId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            CreateOverride(callInfo, questionId, model);
            return callInfo;
        }
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, long questionId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(long id, long questionId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "questionId", questionId);
            DeleteOverride(callInfo, id, questionId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Lbk.MobileApp.Web.Models.AnswerFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Lbk.MobileApp.Web.Models.AnswerFormModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Lbk.MobileApp.Web.Models.AnswerSearchFormModel answer, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(long id, Lbk.MobileApp.Web.Models.AnswerSearchFormModel answer, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit)
        {
            ...
            ListOverride(callInfo, id, answer, pagedDataInput, btnSubmit);
            return callInfo;
        }
