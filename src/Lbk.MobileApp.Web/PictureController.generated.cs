...
namespace Lbk.MobileApp.Web.Controllers
{
    public partial class PictureController
    {
        ...
        protected PictureController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PictureController Actions { get { return MVC.Picture; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Picture";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Picture";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _grid = "~/Views/Picture/_grid.cshtml";
            public readonly string _search = "~/Views/Picture/_search.cshtml";
            public readonly string Create = "~/Views/Picture/Create.cshtml";
            public readonly string Delete = "~/Views/Picture/Delete.cshtml";
            public readonly string Detail = "~/Views/Picture/Detail.cshtml";
            public readonly string Edit = "~/Views/Picture/Edit.cshtml";
            public readonly string List = "~/Views/Picture/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PictureController : Lbk.MobileApp.Web.Controllers.PictureController
    {
        public T4MVC_PictureController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Lbk.MobileApp.Web.Models.PictureFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Lbk.MobileApp.Web.Models.PictureFormModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Lbk.MobileApp.Web.Models.PictureFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Lbk.MobileApp.Web.Models.PictureFormModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Lbk.MobileApp.Web.Models.PictureSearchFormModel picture, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(Lbk.MobileApp.Web.Models.PictureSearchFormModel picture, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit)
        {
            ...
            ListOverride(callInfo, picture, pagedDataInput, btnSubmit);
            return callInfo;
        }
