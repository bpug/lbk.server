...
namespace Lbk.MobileApp.Web.Controllers
{
    public partial class FoodController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FoodController Actions { get { return MVC.Food; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _grid = "~/Views/Food/_grid.cshtml";
            public readonly string _search = "~/Views/Food/_search.cshtml";
            public readonly string Create = "~/Views/Food/Create.cshtml";
            public readonly string Delete = "~/Views/Food/Delete.cshtml";
            public readonly string Detail = "~/Views/Food/Detail.cshtml";
            public readonly string Edit = "~/Views/Food/Edit.cshtml";
            public readonly string List = "~/Views/Food/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FoodController : Lbk.MobileApp.Web.Controllers.FoodController
    {
        public T4MVC_FoodController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long menuId, long categoryId, Lbk.MobileApp.Web.Models.FoodFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(long menuId, long categoryId, Lbk.MobileApp.Web.Models.FoodFormModel model)
        {
            ...
            CreateOverride(callInfo, menuId, categoryId, model);
            return callInfo;
        }
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, long menuId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(long id, long menuId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "menuId", menuId);
            DeleteOverride(callInfo, id, menuId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Lbk.MobileApp.Web.Models.FoodFormModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Lbk.MobileApp.Web.Models.FoodFormModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Lbk.MobileApp.Web.Models.FoodSearchFormModel question, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(long id, Lbk.MobileApp.Web.Models.FoodSearchFormModel question, Lbk.MobileApp.Core.PagedDataInput pagedDataInput, string btnSubmit)
        {
